  ...
  return (
    <div className='container mt-10'>
        ...
        <div className='flex flex-col gap-6 lg:grid lg:grid-cols-3' style={{gridAutoRows: "96px"}}>
            <div className="row-start-1 row-end-3 rounded-2xl p-[1px] bg-slate-200 hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200 group">
                <div className="gap-4 bg-slate-50 rounded-2xl w-full h-full p-6 flex flex-col items-center group-hover:bg-gradient-to-br group-hover:from-red-50 group-hover:via-purple-50 group-hover:to-yellow-50">
                    <h3 className='text-2xl'>Native Notifications</h3>
                    <img src={Asset37} alt="Notification" />
                </div>
            </div>
            <div className="row-start-1 row-end-4 rounded-2xl p-[1px] bg-slate-200 hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200 group">
                <div className="gap-4 bg-slate-50 rounded-2xl w-full h-full p-6 flex flex-col items-center group-hover:bg-gradient-to-br group-hover:from-red-50 group-hover:via-purple-50 group-hover:to-yellow-50">
            ...
            <div className="row-start-3 row-end-6 rounded-2xl p-[1px] bg-slate-200 hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200 group">
                <div className="gap-4 bg-slate-50 rounded-2xl w-full h-full p-6 flex flex-col items-center group-hover:bg-gradient-to-br group-hover:from-red-50 group-hover:via-purple-50 group-hover:to-yellow-50">
                    <h3 className='text-2xl'>App Updates</h3>
            ...
            <div className="row-start-4 row-end-6 rounded-2xl p-[1px] bg-slate-200 hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200 group">
                <div className="gap-4 bg-slate-50 rounded-2xl w-full h-full p-6 flex flex-col items-center group-hover:bg-gradient-to-br group-hover:from-red-50 group-hover:via-purple-50 group-hover:to-yellow-50">
                    <h3 className='text-2xl'>Native Notifications</h3>
                    <img src={Asset37} alt="Notification" />
                </div>
