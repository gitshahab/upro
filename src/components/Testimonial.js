        ...
        <div className='rounded-xl border flex flex-col lg:flex-row items-end'>
            <div id="left" className='flex flex-col gap-12 p-8'>
                <div className='flex gap-2 items-center'>
                    <img className='h-10' src={assets.Asset9} alt="clickup" />
                ...
                <div id="tags" className='flex flex-wrap gap-3 max-w-7xl'>
                    ...
                    <div className='flex items-center gap-4 mt-10'>
                        <img className="rounded-full" src={assets.Asset45} alt="Zeb" />
                        <span>
                            <h3>Zeb Evans</h3>
            ...
            <div id="right">
                <img src={assets.Asset34} className='pl-12' alt="ClickUp" />
            </div>
        </div>
                ...
                <div className='rounded-2xl gradient-inner flex'>
                    <div className='flex flex-col gap-2 p-3'>
                        ...
                        <div className='flex items-center gap-4 mt-4'>
                            <img className="rounded-full" src={assets.Asset36} alt="Rise" />
                            <span>
                                <h3>Rick Pastoor</h3>
            ...
            <div className='rounded-2xl gradient-outer group'>
                <div className='rounded-2xl gradient-inner flex'>
                    <div className='flex flex-col gap-2 p-3'>
                        ...
                        <div className='flex items-center gap-4 mt-4'>
                            <img className="rounded-full h-12" src={assets.Asset37} alt="Rise" />
                            <span>
                                <h3>Yul Chi</h3>
